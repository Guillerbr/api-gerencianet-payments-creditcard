...
<html>
    <head>
        ...
        <script type='text/javascript'>var s=document.createElement('script');s.type='text/javascript';var v=parseInt(Math.random()*1000000);s.src='https://sandbox.gerencianet.com.br/v1/cdn/cb3cd6ce5c2e565ecd4939c016ea94dc/'+v;s.async=false;s.id='cb3cd6ce5c2e565ecd4939c016ea94dc';if(!document.getElementById('cb3cd6ce5c2e565ecd4939c016ea94dc')){document.getElementsByTagName('head')[0].appendChild(s);};$gn={validForm:true,processed:false,done:{},ready:function(fn){$gn.done=fn;}};</script>
        <title></title>
    </head>
    <body>
                    ...
                    <div class="col-lg-3">
                     ...
                     <div  class="col-lg-3">
                        ...
                        <div id="div_installments" class="form-group alert alert-success">
                                 <label for="exampleInputPassword1">Número de parcelas: (<em style="color: white" class="atributo">installments</em>)</label>
        ...
        <div id="boleto" class="col-lg-8 hide">
            <div class="panel panel-success">
                <div id="" class="panel-body">
                    <table class="table"> 
                        <caption><h3>Retorno do pagamento.</h3></caption> 
                        <thead> 
                            <tr>
